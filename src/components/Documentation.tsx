    ...
    <>
      <section id="what-is-lifevault" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          LifeVault is a file-system-first organizer designed for the modern
          individual. It doesn't replace your storage; it{" "}
          <strong>augments</strong> it. By layering a smart structure over your
          existing cloud and local folders, LifeVault helps you manage IDs,
        ...
        <div className="bg-base-200 border border-base-300 rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-base-content/60 text-sm">
              LifeVault never uploads your files to its own servers. Your data
              stays in your control, on your devices and your chosen cloud
              providers.
            </p>
          </div>
        </div>
      ...
      <section id="quick-start-guide" className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={item.step}
              className="bg-base-200 border border-base-300 rounded-lg p-5"
            >
      ...
      <section id="developer-api" className="mb-12">
        ...
        <p className="text-base-content/60 mb-6">
          LifeVault offers a local-first API to interact with your vault
          programmatically. Here is how you can fetch your expiring warranties
          via CLI:
        </p>
  ...
  return (
    <>
      <section id="overview" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          LifeVault's Smart Naming feature automatically renames your files
          using consistent, human-readable conventions. No more files named{" "}
          ...
          — every file gets a descriptive, organized name.
        </p>
        <div className="bg-base-200 border border-base-300 rounded-lg p-4 flex items-start gap-3">
          <Info className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
          <div>
            ...
            <p className="text-base-content/60 text-sm">
              Smart Naming creates renamed copies or symlinks — your original
      ...
      <section id="naming-patterns" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          LifeVault supports several built-in naming patterns that you can apply
          per category:
        </p>
          ...
          {[
            {
              ...
              example: "warranty_2024-03-15_macbook-pro.pdf",
            },
            {
              pattern: "{year}/{month}/{description}",
              example: "2024/03/tax-return-federal.pdf",
            },
            {
              pattern: "{provider}_{type}_{date}",
              example: "apple_warranty_2024-03-15.pdf",
            },
          ].map((item, i) => (
            <div
              key={i}
      ...
      <section id="custom-rules" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          You can define custom naming rules using LifeVault's rule engine.
          Rules are applied in priority order and can match by file type,
          category, tags, or metadata fields.
        </p>
        <div className="bg-base-200 border border-base-300 rounded-lg overflow-hidden">
          <pre className="p-4 sm:p-6 text-sm overflow-x-auto">
            <code>
  ...
  return (
    <>
      <section id="overview" className="mb-12">
        <h2 className="text-2xl font-bold mb-4">Overview</h2>
        <p className="text-base-content/70 leading-relaxed mb-6">
          LifeVault creates a logical folder hierarchy on top of your existing
          storage. It doesn't move your files — it layers structure through
          symlinks, metadata indexes, and virtual folders.
        </p>
      </section>
...
└── .lifevault/
    ...
    └── metadata/`}
      ...
      <section id="customization" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          You can fully customize the folder hierarchy by editing your vault's
          configuration. Add new top-level categories, change nesting depth, or
          create entirely custom structures.
        </p>
        <div className="bg-base-200 border border-base-300 rounded-lg p-4 flex items-start gap-3">
          <Info className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
          <div>
            ...
            <p className="text-base-content/60 text-sm">
              LifeVault ships with presets for common use cases: Personal
              Documents, Business, Medical Records, and Home Management.
            </p>
          </div>
        </div>
      </section>
  ...
  return (
    <>
      <section id="overview" className="mb-12">
        <h2 className="text-2xl font-bold mb-4">Overview</h2>
        <p className="text-base-content/70 leading-relaxed mb-6">
          LifeVault integrates with your existing cloud storage providers. It
          doesn't create yet another cloud silo — it works with the services you
      ...
      <section id="configuration" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          To connect a cloud provider, open Settings and navigate to the Storage
          tab. Click "Add Provider" and follow the authorization flow.
        </p>
        <div className="bg-base-200 border border-base-300 rounded-lg overflow-hidden">
          <pre className="p-4 sm:p-6 text-sm overflow-x-auto">
            <code>
  ...
  return (
    <>
      <section id="overview" className="mb-12">
        <h2 className="text-2xl font-bold mb-4">Overview</h2>
        <p className="text-base-content/70 leading-relaxed mb-6">
          Tags and metadata let you add rich, searchable information to your
          documents beyond just file names and folders. Think of it as a
          personal database for your documents.
        </p>
      </section>
      ...
      <section id="adding-tags" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          Tags are flexible labels you can attach to any document. Use them for
        ...
        <div className="bg-base-200 border border-base-300 rounded-lg overflow-hidden">
          <pre className="p-4 sm:p-6 text-sm overflow-x-auto">
            <code>
              ...
              <span className="text-success">
                "expiring-soon,apple,electronics"
              </span>
            </code>
          </pre>
        </div>
      ...
      <section id="metadata-fields" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          Each document can have structured metadata fields. Some are
          auto-populated, others you can set manually:
        </p>
  ...
  return (
    <>
      <section id="overview" className="mb-12">
        <h2 className="text-2xl font-bold mb-4">Overview</h2>
        <p className="text-base-content/70 leading-relaxed mb-6">
          LifeVault provides end-to-end encryption for your most sensitive
          documents. Encryption happens locally on your device — your keys never
          leave your machine.
        </p>
        <div className="bg-base-200 border border-base-300 rounded-lg p-4 flex items-start gap-3">
          <Info className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
          <div>
            ...
            <p className="text-base-content/60 text-sm">
              Even if you sync encrypted files to the cloud, your provider
              cannot read them. Only you hold the decryption keys.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          LifeVault uses AES-256-GCM for file encryption and Argon2id for key
          derivation. The encryption flow is:
        </p>
        <div className="space-y-3">
          {[
      ...
      <section id="key-management" className="mb-12">
        ...
        <p className="text-base-content/70 leading-relaxed mb-6">
          Your encryption keys are stored in your system's secure keychain
          (macOS Keychain, Windows Credential Store, or Linux Secret Service).
          You can also export a recovery key for backup.
        </p>
        <div className="bg-base-200 border border-base-300 rounded-lg overflow-hidden">
          <pre className="p-4 sm:p-6 text-sm overflow-x-auto">
            <code>
...
const contentComponents: Record<string, () => ReactElement> = {
...
export default function Documentation({
  ...
  const ContentComponent =
    contentComponents[currentSlug] || IntroductionContent;
          ...
          <aside className="hidden xl:block w-56 flex-shrink-0">
            <div className="sticky top-20 overflow-y-auto p-4 pt-12">
              ...
              <div className="bg-base-200 border border-base-300 rounded-lg p-4">
                <h4 className="text-warning font-semibold text-xs mb-1">
                  NEED HELP?
                </h4>
