      ...
      <div className="container mx-auto max-w-7xl px-4 flex items-center">
        ...
        <ul className="menu menu-horizontal px-1 gap-1 hidden md:flex ml-6">
          <li>
            <a
              href="/"
              className={`font-medium ${isActive("/") ? "active text-primary" : ""}`}
            >
              Home
            </a>
          </li>
          <li>
            <a
              href="/download"
              className={`font-medium ${isActive("/download") ? "active text-primary" : ""}`}
            >
              Download
            </a>
          </li>
          <li>
            <a
              href="/docs"
              className={`font-medium ${isActive("/docs") ? "active text-primary" : ""}`}
            >
              Docs
            </a>
          </li>
          <li>
            <a
              href="/faq"
              className={`font-medium ${isActive("/faq") ? "active text-primary" : ""}`}
            >
              FAQ
            </a>
          </li>
