          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card bg-base-100 shadow-lg border border-base-300 mb-8">
              <div className="card-body">
                ...
                <p className="text-base-content/70 mb-4">
                  Welcome to LifeVault. These Terms and Conditions ("Terms")
                  govern your use of the LifeVault desktop application and
                  website (collectively, the "Service") operated by Sabr Labs
                  ("we," "us," or "our").
                </p>
                <p className="text-base-content/70 mb-4">
                ...
                <div className="alert alert-info">
                  ...
                  <span>
                    Please read these Terms carefully before using LifeVault.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-lg border border-base-300 mb-8">
              <div className="card-body">
                ...
                <p className="text-base-content/70 mb-4">
                  ...
                  non-transferable, revocable license to use the LifeVault
                ...
                <ul className="list-disc list-inside text-base-content/70 space-y-2 mb-4">
                  <li>
                    Download and install LifeVault on devices you own or control
                  </li>
                  <li>
                    Use LifeVault to organize your personal files and documents
                  </li>
                ...
                <ul className="list-disc list-inside text-base-content/70 space-y-2">
                  <li>
                    Copy, modify, or distribute the application or its source
                    code
                  </li>
                  <li>
            ...
            <div className="card bg-base-100 shadow-lg border border-base-300 mb-8">
              <div className="card-body">
                ...
                <ul className="list-disc list-inside text-base-content/70 space-y-2">
                  <li>
                    Maintaining the security of your device and any files you
                    organize with LifeVault
                  </li>
                  <li>Creating regular backups of your important documents</li>
                  <li>
                    Ensuring you have the right to store and organize any files
                    you use with the application
                  </li>
                  <li>
                  ...
                  <li>
                    Not using the Service to store, organize, or manage illegal
                    content
                  </li>
                </ul>
              </div>
            ...
            <div className="card bg-base-100 shadow-lg border border-base-300 mb-8">
              <div className="card-body">
                ...
                <p className="text-base-content/70 mb-4">
                  ...
                  SHALL SABR LABS, ITS AFFILIATES, DIRECTORS, EMPLOYEES, OR
                ...
                <ul className="list-disc list-inside text-base-content/70 space-y-2 mb-4">
                  ...
                  <li>
                    Damages resulting from any bugs, viruses, or other harmful
                    code
                  </li>
                </ul>
                <p className="text-base-content/70">
                  ...
                  for the Service during the twelve (12) months preceding the
                  claim.
                </p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-lg border border-base-300 mb-8">
              <div className="card-body">
                ...
                <p className="text-base-content/70 mb-4">
                  LifeVault is a local-first application that helps you organize
                  files stored on your devices. You acknowledge and agree that:
                </p>
                <ul className="list-disc list-inside text-base-content/70 space-y-2">
                  <li>
                  ...
                  <li>
                    We do not have access to your files and cannot recover lost
                    data
                  </li>
                  <li>
                    You should regularly verify that your organization settings
            ...
            <div className="card bg-base-100 shadow-lg border border-base-300 mb-8">
              <div className="card-body">
                ...
                <ul className="list-disc list-inside text-base-content/70 space-y-2 mb-4">
                  ...
                  <li>
                    Sending you a notification through the application (for
                    significant changes)
                  </li>
                </ul>
                <p className="text-base-content/70">
            ...
            <div className="card bg-base-100 shadow-lg border border-base-300 mb-8">
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  ...
                  with the laws of the jurisdiction in which Sabr Labs operates,
